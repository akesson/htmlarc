...
`htmlarc-format`, `htmlarc-macros`), the `htmlarc` and `zim2htmlarc` CLIs, and any future
official Python or MCP-server bindings.

## Pricing & contact

Pricing depends on your use case and organization size — please get in touch and we'll sort out
terms quickly.

**Contact:** [@akesson on GitHub](https://github.com/akesson)

I'm also available for **paid contract work** to extend, integrate, or maintain htmlarc for your
use case — same contact.
