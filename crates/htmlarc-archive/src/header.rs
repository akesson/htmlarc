...
//! | 8      | format version (9 = per-bundle strings)  |
//! | 9      | endianness (0 = little-endian)           |
//! | 10..16 | reserved (zero)                          |
//!
//! Version 9 is a bundle-segmented, footer-indexed container (see [`crate::trailer`],
...
//! [`BundleStrings`](crate::bundle_strings) block (v8 stored it inline); v8 and older layouts are
